...
build:
	@aapt package -M data/AndroidManifest.xml -I $$ANDROID_SDK_ROOT/platforms/android-37.2/android.jar -F stub-unaligned.apk --min-sdk-version 24 --target-sdk-version 37
